 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(R,L){var M=R.length;R.push(L);e:for(;0<M;){var oe=M-1>>>1,he=R[oe];if(0<i(he,L))R[oe]=L,R[M]=he,M=oe;else break e}}function n(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var L=R[0],M=R.pop();if(M!==L){R[0]=M;e:for(var oe=0,he=R.length,Ps=he>>>1;oe<Ps;){var kn=2*(oe+1)-1,Yl=R[kn],xn=kn+1,Os=R[xn];if(0>i(Yl,M))xn<he&&0>i(Os,Yl)?(R[oe]=Os,R[xn]=M,oe=xn):(R[oe]=Yl,R[kn]=M,oe=kn);else if(xn<he&&0>i(Os,M))R[oe]=Os,R[xn]=M,oe=xn;else break e}}return L}function i(R,L){var M=R.sortIndex-L.sortIndex;return M!==0?M:R.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],c=1,d=null,h=3,p=!1,g=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(R){for(var L=n(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=R)r(u),L.sortIndex=L.expirationTime,e(a,L);else break;L=n(u)}}function w(R){if(y=!1,_(R),!g)if(n(a)!==null)g=!0,ql(T);else{var L=n(u);L!==null&&Ql(w,L.startTime-R)}}function T(R,L){g=!1,y&&(y=!1,m(O),O=-1),p=!0;var M=h;try{for(_(L),d=n(a);d!==null&&(!(d.expirationTime>L)||R&&!rt());){var oe=d.callback;if(typeof oe=="function"){d.callback=null,h=d.priorityLevel;var he=oe(d.expirationTime<=L);L=t.unstable_now(),typeof he=="function"?d.callback=he:d===n(a)&&r(a),_(L)}else r(a);d=n(a)}if(d!==null)var Ps=!0;else{var kn=n(u);kn!==null&&Ql(w,kn.startTime-L),Ps=!1}return Ps}finally{d=null,h=M,p=!1}}var N=!1,P=null,O=-1,Q=5,U=-1;function rt(){return!(t.unstable_now()-U<Q)}function ni(){if(P!==null){var R=t.unstable_now();U=R;var L=!0;try{L=P(!0,R)}finally{L?ri():(N=!1,P=null)}}else N=!1}var ri;if(typeof f=="function")ri=function(){f(ni)};else if(typeof MessageChannel<"u"){var dh=new MessageChannel,jv=dh.port2;dh.port1.onmessage=ni,ri=function(){jv.postMessage(null)}}else ri=function(){k(ni,0)};function ql(R){P=R,N||(N=!0,ri())}function Ql(R,L){O=k(function(){R(t.unstable_now())},L)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(R){R.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,ql(T))},t.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<R?Math.floor(1e3/R):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(R){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var M=h;h=L;try{return R()}finally{h=M}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(R,L){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var M=h;h=R;try{return L()}finally{h=M}},t.unstable_scheduleCallback=function(R,L,M){var oe=t.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?oe+M:oe):M=oe,R){case 1:var he=-1;break;case 2:he=250;break;case 5:he=1073741823;break;case 4:he=1e4;break;default:he=5e3}return he=M+he,R={id:c++,callback:L,priorityLevel:R,startTime:M,expirationTime:he,sortIndex:-1},M>oe?(R.sortIndex=M,e(u,R),n(a)===null&&R===n(u)&&(y?(m(O),O=-1):y=!0,Ql(w,M-oe))):(R.sortIndex=he,e(a,R),g||p||(g=!0,ql(T))),R},t.unstable_shouldYield=rt,t.unstable_wrapCallback=function(R){var L=h;return function(){var M=h;h=L;try{return R.apply(this,arguments)}finally{h=M}}}})(im);(function(t){t.exports=im})(rm);/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const GI=Math.log(2);class qI{constructor(e){const n=s=>parseInt(Math.log(s)/GI,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Qo=function(t,e,n,r){t.sort(e);const i=function(a,u){const c=u-a;let d,h;if(c===0)return null;if(c===1)return d=t[a],h=n?n(d):d,new me(h,d.node,me.BLACK,null,null);{const p=parseInt(c/2,10)+a,g=i(a,p),y=i(p+1,u);return d=t[p],h=n?n(d):d,new me(h,d.node,me.BLACK,g,y)}},s=function(a){let u=null,c=null,d=t.length;const h=function(g,y){const k=d-g,m=d;d-=g;const f=i(k+1,m),_=t[k],w=n?n(_):_;p(new me(w,_.node,y,null,f))},p=function(g){u?(u.left=g,u=g):(c=g,u=g)};for(let g=0;g<a.count;++g){const y=a.nextBitIsOne(),k=Math.pow(2,a.count-(g+1));y?h(k,me.BLACK):(h(k,me.BLACK),h(k,me.RED))}return c},o=new qI(t.length),l=s(o);return new be(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jx=5*60,Xx=w_("authIdTokenMaxAge")||Jx;let bp=null;const Zx=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Xx)return;const i=n==null?void 0:n.token;bp!==i&&(bp=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function eN(t=T_()){const e=md(t,"auth");if(e.isInitialized())return e.getImmediate();const n=lk(t,{popupRedirectResolver:Gx,persistence:[nx,Vk,pv]}),r=w_("authTokenSyncURL");if(r){const s=Zx(r);Bk(n,s,()=>s(n.currentUser)),zk(n,o=>s(o))}const i=v_("auth");return i&&Ak(n,`http://${i}`),n}Yx("Browser");const sh=I.exports.createContext();function tN(t){const[e,n]=I.exports.useState(!1);return E(sh.Provider,{value:[e,n],children:t.children})}function nN({namaKetua:t,fotoKetua:e,namaWakil:n,fotoWakil:r,score:i}){return Z("div",{className:"w-[95%] h-full py-3 px-3 flex gap-1 bg-slate-300 rounded-md justify-center items-start",children:[Z("div",{className:"w-[40%] flex flex-col gap-2 justify-center items-center  text-[#202121] rounded-lg",children:[E("h1",{className:"font-medium",children:"Ketua"}),E("div",{className:"w-full h-full flex justify-center items-center",children:E("img",{src:e,className:"max-w-[80%] rounded",alt:""})}),E("p",{className:"max-w-[80%] text-lg font-semibold text-ellipsis",children:t})]}),Z("div",{className:"w-[40%] flex flex-col gap-2 justify-center items-center  text-[#202121] rounded-lg",children:[E("h1",{className:"font-medium",children:"Wakil Ketua"}),E("div",{className:"w-full h-full flex justify-center items-center",children:E("img",{src:r,className:"max-w-[80%] rounded",alt:""})}),E("p",{className:"max-w-[90%] text-lg font-semibold text-ellipsis",children:n})]}),Z("div",{className:"w-[20%] h-full flex flex-col gap-2 justify-center items-center bg-[#212121] my-auto  text-[#202121] p-2 rounded-md",children:[E("h1",{className:"text-white",children:"Total"}),E("p",{className:"max-w-[90%] text-xl font-bold text-white text-ellipsis",children:i})]})]})}function rN(){const[t,e]=I.exports.useState();I.exports.useState([]);const[n,r]=I.exports.useState(!0),[i,s]=I.exports.useState(0),o=ad();I.exports.useContext(sh);const[l,a]=I.exports.useContext(Bl);return I.exports.useEffect(()=>{a(JSON.parse(localStorage.getItem("user")));const u=ol(),c=oc(u,"jayabuana");Hy(c,d=>{const h=d.val();let g=Object.values(h).slice(0);g.sort((k,m)=>m.score-k.score),e(g),r(!1);let y=0;g.map(k=>{y+=k.score}),s(y)})},[]),Z("div",{className:"container max-w-md mx-auto pt-8 px-8",children:[E("div",{className:"flex justify-center gap-4 mt-4 mb-5",children:E("h1",{className:"text-2xl font-semibold text-black text-center",children:"Hasil Pemilihan Ketua OSIS 2023"})}),n&&E(nk,{}),!n&&E("div",{className:"w-full  max-w-[400px] bg-slate-100  flex flex-col items-center mx-auto rounded-lg pb-4 pt-3 gap-3 ",children:Z(Ve,{children:[t==null?void 0:t.map(u=>E(nN,{namaKetua:u.namaKetua,namaWakil:u.namaWakil,fotoKetua:u.fotoKetua,fotoWakil:u.fotoWakil,score:u.score},u.nomor)),E("div",{className:"mt-4",children:Z("h1",{className:"text-lg",children:["Total Suara Terkumpul : ",Z("span",{className:"font-semibold",children:[" ",i]})]})})]})}),E("div",{className:"flex justify-center items-center my-5",children:E(ik,{name:"LOGOUT",click:()=>{localStorage.clear(),o("/"),window.location.reload()}})})]})}var iN="firebase",sN="9.12.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
